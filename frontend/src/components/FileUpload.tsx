...
const FileUpload: React.FC<FileUploadProps> = ({ token, shouldCompare }) => {
    ...
    const generatePDF = () => {
        ...
        let y = 60;
        reportData.differences.forEach((diff: string) => {
            doc.text(diff, 10, y);
            y += 10;
            if (y > 280) {
                doc.addPage();
        ...
        <div className="min-h-screen flex flex-col items-center justify-center bg-gray-100 p-4">
            ...
            {differences.length > 0 && (
                <div className="mt-4 bg-white p-6 rounded shadow-md w-full max-w-4xl">
                    ...
                    <div className="mb-4 p-4 bg-gray-100 border rounded max-h-64 overflow-y-auto">
